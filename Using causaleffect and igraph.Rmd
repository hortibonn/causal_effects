...
The result of this function is readable in Latex. We can replace the double slash '\\' with a single '\' so that it is also readable in Rmarkdown when wrapped in '$' symbols in R markdown results in a LateX formula look like this: 
